...
from avito_parser.locales.ru import *
from avito_parser.config import save_avito_config, load_avito_config
from avito_parser.core import AvitoParse
from avito_parser.loaders.user_login import prompt_user_login
from avito_parser.version import VERSION


def main(page: ft.Page):
    page.title = f'Parser Avito v {VERSION}'
    # page.window.icon = ... (removed)
